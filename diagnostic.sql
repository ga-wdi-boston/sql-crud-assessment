...
SELECT (*)
FROM licensees
WHERE eye_color = 'Hazel' AND  eye_color = 'Brown' AND hair_color = 'BLACK'

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE (*) SET height = height - 1 WHERE given_name = 'Marilynn', surname= 'Escobar'
AND given_name = 'Chris', surname = 'Whaley'

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees WHERE name = 'Dylan' AND name = 'Teresita'
