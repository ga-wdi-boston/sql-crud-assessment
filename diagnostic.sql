...
SELECT * FROM licensees WHERE eye_color='hazel' and (hair_color='black' or hair_color='brown')
;
...
UPDATE licensees
SET height = height - 1
WHERE (surname='Escobar' and given_name='Marilyn') or (surname='Whaley' and given_name='Chris');

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees WHERE (surname='Rich' and given_name='Dylan') or (surname='Myers' and given_name='Teresita');
