...
(surname, given_name, gender, height,
  weight, born_on, eye_color, hair_color) VALUES
...
UPDATE licensees SET height = (height - 1) WHERE (surname = 'Escobar' and given_name = 'Marilynn') or (surname = 'Whaley' and given_name = 'Chris');
