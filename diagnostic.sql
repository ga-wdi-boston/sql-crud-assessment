...
INSERT INTO licenees (surname, given_name, gender, height, weight, born_on, eye_color, hair_color) VALUES ('Bishop', 'Caren', 'f', 63, 132, 1943-09-26, 'Brown', 'Black')
-- your code here
...
UPDATE licensees SET height = height - 1 WHERE surname = 'Escobar' OR surname = 'Whaley';
SELECT * FROM patients WHERE surname = 'Escobar' OR surname = 'Whaley';

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM patients WHERE surname = 'Escobar';
DELETE FROM patients WHERE surname = 'Myers';
