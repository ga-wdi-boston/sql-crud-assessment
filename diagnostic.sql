...
UPDATE licensees
SET height = height - 1
WHERE given_name + '' + surname = 'Marilyn Escobar', 'Chris Whaley'
;
-- ^^ not sure whether using a plus sign to combine constraints is the way to do it. Same for question 5.
-- Also not sure whether using a comma between 'Brown' and 'Black' in question 3 is the way to do that.

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees
WHERE given_name + '' + surname = 'Dylan Rich', 'Teresita Myers'
;
