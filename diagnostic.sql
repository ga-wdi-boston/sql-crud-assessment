...
SELECT COUNT(*)
FROM licensees
GROUP BY (eye_color = 'hazel') (hair_color = 'brown' | 'black')

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE licensees(given_name = 'Marilynn' , 'Chris' surname = 'Escobar', 'Whaley')
SET weight = weight - 1
;
...
DELETE FROM licensees
  WHERE given_name = 'Dylan, Teresita' && surname = 'Myers, Rich'
