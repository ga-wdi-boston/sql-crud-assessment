...
INSERT INTO
  liscensees (surname, given_name, gender, height, weight, born_on, eye_color, hair_color)
SELECT 'Bishop', 'Caren', 'f', 63, 132, DATE '1958-09-22', 'Brown', 'Black'
;
...
UPDATE liscensees
SET height = height -1
WHERE surname = 'Escobar' OR surname = 'Whaley'
;

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM liscensees WHERE surname = 'Rich' AND given_name = 'Dylan';

DELETE FROM liscensees WHERE surname = 'Myers' AND given_name = 'Teresita';
