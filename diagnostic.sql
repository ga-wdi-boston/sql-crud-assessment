...
-- Question 3. Write a query to get all attributes of licensees with Hazel eye color
-- and Brown or Black hair color.
SELECT *
FROM licensees
WHERE eye_color = 'Hazel' AND hair_color IN ('Brown', 'Black');
