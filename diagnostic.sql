...
FROM licensees
WHERE eye_color = 'Hazel' AND hair_color = 'Black' OR hair_color = 'Brown' AND eye_color = 'Hazel';

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.
UPDATE licensees
SET height = height - 1
WHERE given_name = 'Marilyn' AND surname = 'Escobar' OR given_name = 'Chris' AND surname = 'Whaley';
