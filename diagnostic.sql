...
-- Question 2. Add `Bishop, Caren, f, 63, 132, 1943-09-26, Brown, Black` into the table of
--licensees.
...
-- Question 3. Write a query to get all attributes of licensees with Hazel eye color and Brown or Black hair color.
 ...
 SELECT * FROM licensees WHERE eye_color LIKE '%Hazel%' AND hair_color IN ('Brown', 'Black');
