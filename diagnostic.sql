...
SELECT * FROM licensees WHERE eye_color='Hazel' AND hair_color='Black';
...
DELETE licensees WHERE surname='Dylan' AND given_name='Rich';
DELETE licensees WHERE surname='Myers' AND given_name='Teresia';
