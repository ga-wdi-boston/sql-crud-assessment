...
CREATE TABLE licensees (id number SERIAL PRIMARY KEY,
                        surname TEXT,
                        given_name TEXT,
                        gender INTEGER,
                        height INTEGER,
