...
select count(*) brown, black from hair_color
...
alter table licensees
  alter Marilynn Escobar height - 1
  alter Chris Whaley height -1

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.
delete from licensees = Dylan Rich

delete from licensees = Teresita Myers
