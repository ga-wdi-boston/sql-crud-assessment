...
SELECT hair_color, eye_color, COUNT(*)
FROM licensees
WHERE hair_color = 'Black' || 'Brown'
GROUP BY hair_color, eye_color
HAVING eye_color = 'Hazel';
-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE licensees *
  SET height = height + 1
  WHERE given_name = "Marilynn" || "Escobar" || "Chris";
