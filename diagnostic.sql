...
INSERT INTO licensees ('Bishop', 'Caren', 'f', 63, 132, 1943-09-26, 'Brown', 'Black')
...
GET licensees (eye_color = 'Hazel', hair_color = 'Brown' 'Black')

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE licensees ('Escobar','Marilynn','f',63,143,1944-10-09,'Brown','Red') ('Whaley','Chris','o',71,177,1994-07-08,'Brown','Black')

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE licensees ('Dylan' 'Rich', 'Teresita' 'Myers')
