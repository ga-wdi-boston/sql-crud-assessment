...
-- INSERT INTO licenses(surname, given_name, gender, height, weight, born_on, eye_color, hair_color)
-- VALUES
...
-- UPDATE licenses SET height = height - 1 WHERE surname = 'Whaley' AND given_name = 'Chris';
