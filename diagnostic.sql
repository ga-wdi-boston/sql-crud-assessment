...
SELECT surname,given_name,gender,height,weight,born_on,eye_color,hair_color
FROM licensees
WHERE eye_color = 'Hazel' AND hair_color = 'Brown' OR eye_color = 'Hazel' AND hair_color = 'Black'
;
