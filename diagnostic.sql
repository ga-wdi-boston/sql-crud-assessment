...
SELECT * FROM patients(eye_color,hair_color)
...
UPDATE patients(surname,given_name)
  SELECT 'Escobar', 'Marilynn'
  UNION
  SELECT 'Whaley', 'Chris'
  SET height = (height - 1);
...
TRUNCATE patients(surname,given_name)
  SELECT 'Rich', 'Dylan'
  UNION
  SELECT 'Myers', 'Teresita'
  ;
