...
-- UPDATE licenses
    SET height = height - 1
    WHERE surname, given_name = Marilynn, Escobar   (not sure how to combine the surname and given_name...)
    WHERE surname, given_name = Chris, Whaley       (not sure how to combine the surname and given_name...)
   ;

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

-- DELETE FROM licenses
    WHERE surname, given_name = Dylan, Rich       (not sure how to combine the surname and given_name...)
    WHERE surname, given_name = Teresita, Myers   (not sure how to combine the surname and given_name...)
   ;
