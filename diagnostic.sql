...
-- WHERE hair_color LIKE 'Brown', 'Black';

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE licensees SET height = '' WHERE given_name = 'Marilynn', surname = 'Escobar';
UPDATE licensees SET height = '' WHERE given_name = 'Chris', surname = 'Whaley';

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees WHERE given_name = 'Dylan', surname =  'Rich'
DELETE FROM licensees WHERE given_name = 'Teresita', surname =  'Myers'
