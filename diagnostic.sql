...
UPDATE e.Marilynn_Escobar, e.Chris_Whaley COUNT(*)
SET height = height - 1;

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees e.Dylan_Rich, e.Teresita_Myers
--OUT OF TIME!!
--I haven't had a chance to check any of these.
