...
(surname, given_name, gender, height, weight, born_on, eye_color, hair_color) VALUES ('Bishop', 'Caren', 'f', 63, 132, '1943-09-26', 'Brown', 'Black');
...
SELECT * FROM licensees WHERE eye_color='Hazel' AND IN (hair_color='Brown',hair_color='Black');
