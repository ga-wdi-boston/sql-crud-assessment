...
INSERT INTO licensees (given_name, gender, height, weight, born_on, eye_color, hair_color) VALUES
...
SELECT * FROM licensees WHERE eye_color = 'Brown' OR hair_color = 'Black';

-- Question 4. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

UPDATE licensees
SET height = height - 1
WHERE given_name IN ('Escobar, Marilynn', 'Whaley, Chris')

-- Question 5. Remove Dylan Rich and Teresita Myers from the table of licensees.
DELETE FROM licensees WHERE given_name IN ('Dylan, Rich', 'Myers, Teresita')
