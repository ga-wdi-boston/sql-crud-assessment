...
SELECT * FROM licensees WHERE eye_color = 'Hazel' AND (hair_color = 'Black' OR 'Brown');
...
ALTER TABLE licensees
  SET height = height - 1
  WHERE given_name AND surname = 'Marilynn' and 'Escobar' OR given_name AND surname = 'Chris' AND 'Whaley';
