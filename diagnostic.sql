...
INSERT INTO licensees (family_name,given_name,gender,height,weight,born_on)
  SELECT 'Bishop', 'Caren', 'f', 63, 132, DATE '1943-09-26', 'Brown', 'Black'
...
UPDATE TABLE licensees (given_name, family_name, height)
  SELECT 'Marilynn', 'Escobar'
...
DELETE FROM licensees WHERE family_name = 'Escobar' given_name = 'Marilyn'
