...
INSERT INTO licensees (surname,given_name,gender,height,weight,born_on,eye_color,hair_color) VALUES ('Bishop', 'Caren', '63', '132', 1943-09-25, 'Brown', 'Black');
...
WHERE hair_color = 'Brown' OR 'Black'   -- not 100% on that!
