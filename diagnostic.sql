...
UPDATE licensess
SET surname = 'Bishop', given_name = 'Caren', gender = 'f', height = '63', weight = '132', born_on = '1943-09-26', eye_color = 'Brown', hair_color = 'Black';
...
SET height = height - 1
WHERE
  (surname = 'Escobar' AND given_name = 'Marilynn') OR
  (surname = 'Whaley' AND given_name = 'Chris');
...
WHERE
  (given_name = 'Dylan' AND surname = 'Rich') OR
  (given_name = 'Terisita' AND surname = 'Myers');
