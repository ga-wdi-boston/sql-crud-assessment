...
UPDATE licensees SET height = height - 1 WHERE (given_name = 'Marilynn' AND surname = 'Escobar') OR (given_name = 'Chris' AND surname = 'Whaley');

-- Question 6. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees WHERE (given_name = 'Dylan' AND surname = 'Rich') OR (given_name = 'Teresita' AND surname = 'Myers');
