...
-- your code here
--surname,given_name,gender,height,weight,dob,eye_color,hair_color
...
-- your code here
\copy licensees(surname,given_name,gender,height,weight,dob,eye_color,hair_color) FROM  '/licensees.csv' WITH (HEADER true, FORMAT csv)

-- Question 4. Write a query to get all attributes of licensees with Hazel eye color and Brown or Black hair color.

-- your code here
SELECT * FROM licensees WHERE (hair_color = 'Black' OR hair_color = 'Brown') AND eye_color = 'Hazel' ;

-- Question 5. Make each of Marilynn Escobar and Chris Whaley one inch shorter. Look them up by their names.

-- your code here

UPDATE licensees SET height = height - 1
...
WHERE (given_name = 'Dylan' AND surname = 'Rich') OR
      (given_name = 'Teresita' AND surname = 'Myers')
      ;
