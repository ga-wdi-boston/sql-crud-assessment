...
-- your code here
UPDATE licensees SET height = height - 1 WHERE given_name = 'Marilynn' or given_name = 'Chris';
-- (already checked the database, there is only 1 Marilynn and 1 Chris in licensees)

-- Question 6. Remove Dylan Rich and Teresita Myers from the table of licensees.

-- your code here
DELETE FROM licensees WHERE  given_name = 'Dylan' or given_name = 'Teresita';
-- (also checked the database, there is only 1 Dylan and 1 Teresita in licensees)
