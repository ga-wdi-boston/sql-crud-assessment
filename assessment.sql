...
SELECT eye_color = 'Hazel' AND hair_color = 'Brown' OR hair_color = 'Black' FROM licensees
...
UPDATE licensees
SET height = height - 1
WHERE given_name = 'Marilynn Escobar' AND WHERE given_name = 'Chris Whaley'
;

-- Question 6. Remove Dylan Rich and Teresita Myers from the table of licensees.

DELETE FROM licensees
WHERE given_name = 'Dylan Rich' AND WHERE given_name = 'Teresita Myers'
;
-- your code here
