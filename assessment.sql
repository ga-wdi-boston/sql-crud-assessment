...
INSERT INTO licensees(surname,given_name,gender,weight, height, dob, eye_color, hair_color)
...
FROM licensees
WHERE eye_color = 'Hazel', hair_color = 'Black'
;
...
UPDATE licensees
SET height = height - 1
WHERE given_name IS 'Marilynn', 'Chris' surname IS 'Escobar', 'Whaley'
;
...
WHERE given_name IS 'Dylan', 'Teresita' surname IS 'Rich', 'Myers'
;
