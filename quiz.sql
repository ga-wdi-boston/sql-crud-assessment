...
-- your code starts here
SELECT * FROM people WHERE age > 35 OR title = 'Princess of Winterfell';
-- your code ends here

-- Question 5. Change the motto of one of your houses. Look it up by its name.

-- your code starts here
UPDATE houses SET motto = 'Winter is coming in Boston.' WHERE name = 'House Stark';
-- your code ends here

-- Question 6. Kill off, er, I mean delete one of the people. Look them up by their title.

-- your code starts here
DELETE FROM people where title = 'Deceased';
-- your code ends here
