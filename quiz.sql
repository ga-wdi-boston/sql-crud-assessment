...
-- your code starts here
SELECT * FROM PEOPLE WHERE age > 30 OR title = 'Princess of Winterfell';
-- your code ends here

-- Question 5. Change the motto of one of your houses. Look it up by its name.

-- your code starts here
UPDATE houses SET motto = 'Hear me bark!' WHERE name = 'House Lannister';
-- your code ends here

-- Question 6. Kill off, er, I mean delete one of the people. Look them up by their title.

-- your code starts here
DELETE FROM people WHERE title = 'Hand of the King and Master of Coin';
-- your code ends here
